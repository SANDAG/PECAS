...
public class TestMarquardtMinimizer {
	...
	private static final Vector EPSILON = new DenseVector(new double[] { 1E-6,
			1E-6, 1E-6 });
	...
	public void setUp() throws Exception {
		...
		final GaussBayesianObjective gauss = new GaussBayesianObjective(model,
				theCoeffs, theTargets, targetVariance, means, priorVariance);
	...
	public void testDoOneIteration() throws OptimizationException {
		...
		minnyTheMarquardtMinimizer.reset(new DenseVector(new double[] { 0.2, 0.5,
				0.1 }));
		...
		assertEquals(1.33012,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.00001);
		...
		assertEquals(0.855485,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.000001);
		...
		assertEquals(0.846586,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.000001);

		minnyTheMarquardtMinimizer.reset(new DenseVector(new double[] { 0.9, 0.6,
				0.2 }));
		assertEquals(0, minnyTheMarquardtMinimizer.getNumberOfIterations());
		assertEquals(40.4401,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.0001);
		...
		double lastIterationObjective = minnyTheMarquardtMinimizer
				.getCurrentObjectiveValue();
		minnyTheMarquardtMinimizer.doOneIteration();
		assertEquals(2, minnyTheMarquardtMinimizer.getNumberOfIterations());
		assertTrue(lastIterationObjective > minnyTheMarquardtMinimizer
				.getCurrentObjectiveValue());

		minnyTheMarquardtMinimizer.reset(new DenseVector(new double[] { 0.9, 0.6,
				0.2 }));
		assertEquals(0, minnyTheMarquardtMinimizer.getNumberOfIterations());
		assertEquals(151.777,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.001);
		...
		assertEquals(77.7507,
				minnyTheMarquardtMinimizer.getCurrentObjectiveValue(), 0.0001);

		lastIterationObjective = minnyTheMarquardtMinimizer
				.getCurrentObjectiveValue();
		minnyTheMarquardtMinimizer.doOneIteration();
		assertEquals(2, minnyTheMarquardtMinimizer.getNumberOfIterations());
		assertTrue(lastIterationObjective > minnyTheMarquardtMinimizer
	...
	public void testIterateToConvergence() throws OptimizationException {
		...
		Vector coeffs = minnyTheMarquardtMinimizer
				.iterateToConvergence(EPSILON, 50);
	...
	public void testMinimize() throws OptimizationException {
		...
		minnyTheMarquardtMinimizer.resetPenalty(new DenseVector(new double[] { 0.2,
				0.5, 0.1 }));
		minnyTheMarquardtMinimizer.setOptimizationParameters(1E-7, 1, 0.01);

		final Vector coeffs = minnyTheMarquardtMinimizer.minimize(EPSILON, 50,
				EPSILON, 50);
		assertTrue(minnyTheMarquardtMinimizer.lastRunConverged());
		assertFalse(minnyTheMarquardtMinimizer.lastRunMaxIterations());
		assertFalse(minnyTheMarquardtMinimizer.lastRunInvalidStep());
