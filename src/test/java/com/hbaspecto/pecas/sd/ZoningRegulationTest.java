...
public class ZoningRegulationTest extends TestCase {
	 ...
	 * ZoningPermissions(4,0,1,0); z.setMaxFAR(3); try { z.setMaxFAR(1.01); throw
	 * new
	...
	public void testSetMinFAR() {
		/*
		 * ZoningPermissions z = new ZoningPermissions(4,0,1,0); z.setMinFAR(1.2);
		 * try { z.setMinFAR(3.99); throw new Exception(
		 * "Shoudln't be able to set a FAR this low, need a reasonable range"); }
		 * catch (Exception e) { }; try { z.setMinFAR(4.05); throw new Exception
		 * ("Shoudln't be able to set a FAR this low, need a reasonable range"); }
		 * catch (Exception e) { };
		 */
	}
