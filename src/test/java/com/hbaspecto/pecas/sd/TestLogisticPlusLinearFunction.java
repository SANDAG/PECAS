...
public class TestLogisticPlusLinearFunction {
	...
	public final void testEvaluate() {
		final LogisticPlusLinearFunction lplf = new LogisticPlusLinearFunction(
				1200000, 1, 2, 391507.6, 15225.29);
	...
	public final void testDerivative() {
		...
		while (x < 50) {
			...
			assertTrue("Numerical derivative " + numericalDerivative
					+ " should equal derivative " + derivative + " at " + x,
					Math.abs(numericalDerivative - derivative) < 5);
			oldValue = newValue;
		}
	}
