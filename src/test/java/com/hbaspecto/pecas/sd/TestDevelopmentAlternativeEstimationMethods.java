...
public class TestDevelopmentAlternativeEstimationMethods {
	...
	public void testGetCompositeUtilityTwoRangesWithAdjustments() {
		...
		double computil = DevelopmentAlternative.getCompositeUtility(
				intensityDispersion, landSize, perSpace, perLand, stepPoints,
		...
		computil = DevelopmentAlternative.getCompositeUtility(intensityDispersion,
				landSize, perSpace, perLand, stepPoints, perSpaceAdjustments,
				perLandAdjustments);
	...
	public void testGetCompositeUtility() {
		...
		computil = DevelopmentAlternative.getCompositeUtility(dispersionParameter,
				landArea, perSpaceInitial, perLandInitial, intensityPoints,
				perSpaceAdjustments, perLandAdjustments);
	...
	public void testGetTwoRangeUtilityDerivativesWRTParameters() {
		...
		answers = DevelopmentAlternative.getUtilityDerivativesWRTParameters(
				intensityDispersion, landSize, perSpace, perLand, stepPoints,
				perSpaceAdjustments, perLandAdjustments);
	...
	public void testGetExpectedFARTwoRangesWithAdjustments() {
		...
		double expvalue = DevelopmentAlternative.getExpectedFAR(
				intensityDispersion, landSize, perSpace, perLand, stepPoints,
				perSpaceAdjustments, perLandAdjustments);
		...
		expvalue = DevelopmentAlternative.getExpectedFAR(intensityDispersion,
				landSize, perSpace, perLand, stepPoints, perSpaceAdjustments,
				perLandAdjustments);
	...
	public void testGetExpectedFAR() {
		...
		// With various ranges missing.
		intensityPoints[1] = 0.0;
		expvalue = DevelopmentAlternative.getExpectedFAR(dispersionParameter,
				landArea, perSpaceInitial, perLandInitial, intensityPoints,
				perSpaceAdjustments, perLandAdjustments);
	...
	public void testGetTwoRangeExpectedFARDerivativesWRTParameters() {
		...
		Vector answers = DevelopmentAlternative
				.getExpectedFARDerivativesWRTParameters(intensityDispersion, landSize,
						perSpace, perLand, stepPoints, perSpaceAdjustments,
						perLandAdjustments);
	...
	public void testGetExpectedFARDerivativesWRTParameters() {
		...
		Vector answers = DevelopmentAlternative
				.getExpectedFARDerivativesWRTParameters(dispersionParameter, landArea,
