...
public class TestDevelopMoreAlternative
{
            ...
            ChoiceModelOverflowException
    {
        ...
        // Parcel 2 - high-density commercial.
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(1).get(1)).getExpectedTargetValues(targets);
        ...
        // Parcel 3 - low-density residential.
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(2).get(1)).getExpectedTargetValues(targets);
        ...
        // Parcel 4 - high-density residential.
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(3).get(1)).getExpectedTargetValues(targets);
        assertEquals(0.0, expvalues.get(0), 0.00001);
        assertEquals(0.0, expvalues.get(1), 0.00001);
        assertEquals(0.0, expvalues.get(2), 0.00001);
        ...
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(4).get(1)).getExpectedTargetValues(targets);
        assertEquals(0.0, expvalues.get(0), 0.00001);
        assertEquals(0.0, expvalues.get(1), 0.00001);
        assertEquals(0.0, expvalues.get(2), 0.00001);
        assertEquals(0.0, expvalues.get(3), 0.00001);
        ...
        // Parcel 7 - derelict.
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(6).get(1)).getExpectedTargetValues(targets);
        assertEquals(0.0, expvalues.get(0), 0.00001);
        assertEquals(0.0, expvalues.get(1), 0.00001);
        assertEquals(0.0, expvalues.get(2), 0.00001);
        assertEquals(0.0, expvalues.get(3), 0.00001);
        ...
        // Parcel 8 - vacant.
        land.advanceToNext();
        expvalues = ((DevelopMoreAlternative) alts.get(7).get(1)).getExpectedTargetValues(targets);
        assertEquals(0.0, expvalues.get(0), 0.00001);
        assertEquals(0.0, expvalues.get(1), 0.00001);
        assertEquals(0.0, expvalues.get(2), 0.00001);
        assertEquals(0.0, expvalues.get(3), 0.00001);
