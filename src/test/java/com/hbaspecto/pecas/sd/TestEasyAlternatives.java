...
public class TestEasyAlternatives
{
    ...
    public static void setUpBeforeClass() throws Exception
    {
        ...
        while (land.advanceToNext())
        {
            ...
            final LogitModel demodermodel = (LogitModel) model.getAlternatives().get(0);
    ...
    @Test
    public void testGetUtility() throws NoAlternativeAvailable, ChoiceModelOverflowException
    {
        land.setToBeforeFirst();
        // Parcel 1.
        land.advanceToNext();
        double utility = ((NoChangeAlternative) nochangealts.get(0)).getUtility(disp);
        assertEquals(1.837621, utility, 0.00001);
        utility = ((DemolishAlternative) demoderalts.get(0).get(0)).getUtility(disp);
        assertEquals(-455.331, utility, 0.01);
        utility = ((DerelictAlternative) demoderalts.get(0).get(1)).getUtility(disp);
        ...
        utility = ((DemolishAlternative) demoderalts.get(1).get(0)).getUtility(disp);
        assertEquals(-456.333, utility, 0.01);
        utility = ((DerelictAlternative) demoderalts.get(1).get(1)).getUtility(disp);
        assertEquals(-100.000, utility, 0.01);
        ...
        utility = ((DemolishAlternative) demoderalts.get(2).get(0)).getUtility(disp);
        assertEquals(-35.2756, utility, 0.001);
        utility = ((DerelictAlternative) demoderalts.get(2).get(1)).getUtility(disp);
        assertEquals(-100.000, utility, 0.01);
        ...
        utility = ((DemolishAlternative) demoderalts.get(3).get(0)).getUtility(disp);
        assertEquals(-36.1109, utility, 0.001);
        utility = ((DerelictAlternative) demoderalts.get(3).get(1)).getUtility(disp);
        assertEquals(-100.000, utility, 0.01);
        ...
        utility = ((DemolishAlternative) demoderalts.get(4).get(0)).getUtility(disp);
        assertEquals(-455.331, utility, 0.01);
        utility = ((DerelictAlternative) demoderalts.get(4).get(1)).getUtility(disp);
        assertEquals(-100.000, utility, 0.01);
        ...
        utility = ((DerelictAlternative) demoderalts.get(5).get(0)).getUtility(disp);
        assertEquals(-100.000, utility, 0.01);
        ...
        utility = ((DemolishAlternative) demoderalts.get(6).get(0)).getUtility(disp);
        assertEquals(-455.331, utility, 0.01);
        utility = ((DerelictAlternative) demoderalts.get(6).get(1)).getUtility(disp);
        ...
        assertEquals(0.0, utility, 0.00001);
        utility = ((DemolishAlternative) demoderalts.get(7).get(0)).getUtility(disp);
        assertEquals(Double.NEGATIVE_INFINITY, utility);
        utility = ((DerelictAlternative) demoderalts.get(7).get(1)).getUtility(disp);
        assertEquals(Double.NEGATIVE_INFINITY, utility);
    ...
    @Test
    public void testGetUtilityDerivativesWRTParameters() throws NoAlternativeAvailable,
            ChoiceModelOverflowException
    {
