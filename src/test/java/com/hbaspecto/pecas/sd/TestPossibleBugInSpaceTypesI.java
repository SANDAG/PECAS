...
public class TestPossibleBugInSpaceTypesI
{
    ...
    public void testPossibleBug()
    {
        ...
        final double from3to5 = SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(3)
                .getTransitionConstantTo(session, 5);
        assertEquals(122, from3to5, 0.1);
        final double from3to3 = SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(3)
                .getTransitionConstantFrom(session, 3);
