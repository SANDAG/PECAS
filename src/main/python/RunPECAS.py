""" Configure program and define utility routines """
...
def myMain():
    """Main method for running PECAS"""
    
    logging.info("**********************")
    logging.info("Starting PECAS Run in " + ps.scendir + ". MapIt scenario " 
                 + ps.scenario + ", SD schema " + ps.sd_schema)
    rd.resetdatabase()
    year = ps.startyear
