...
/**
 * This class describes amounts of commodities. It is used as an abstract base class for ProductionFunctions and ConsumptionFunctions
 * 
 * @author John Abraham
 */
public interface CommodityQuantities
{
    ...
    /**
     * returns the commodity at the position i from the last sort, i.e. the commodity that was at position i in the variable commodityCollection that
    ...
    /**
     * This function calculates the amount of each commodity given the utility of each commodity. sortToMatch must have been previously called to
