...
public interface CommodityQuantities {
	...
	/**
	 * This function calculates the amount of each commodity given the utility of
	 * each commodity. sortToMatch must have been previously called to establish
	 * the order and number of commodities
	 * 
