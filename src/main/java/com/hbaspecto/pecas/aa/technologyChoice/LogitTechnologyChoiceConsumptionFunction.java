...
public class LogitTechnologyChoiceConsumptionFunction
        implements ConsumptionFunction
{
    ...
    @Override
    public double[] calcAmounts(double[] buyingZUtilities, double[] sellingZUtilities, int zoneIndex)
            throws NoAlternativeAvailable
    {
        try
        {
            return myTechnologyChoice.calcBuyingAmounts(buyingZUtilities, sellingZUtilities,
                    zoneIndex);
