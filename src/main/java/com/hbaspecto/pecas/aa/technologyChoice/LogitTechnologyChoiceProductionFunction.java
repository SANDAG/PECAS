...
public class LogitTechnologyChoiceProductionFunction
        implements ProductionFunction
{
            ...
            throws NoAlternativeAvailable
    {
        try
        {
            return myTechnologyChoice.calcSellingAmounts(buyingZUtilities, sellingZUtilities,
                    zoneIndex);
