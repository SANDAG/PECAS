        ...
        extends JPPFTask
{
    ...
    FlowAllocator(String cName, double[] tp, double[] tc, double[] dTP, double[] dTC,
            double[] prices, boolean calculatingSizeTerms)
    {
        commodityName = cName;
    ...
    public void run()
    {
        try
        {
            ...
            try
            {
                ...
                {
                    logger.debug("Setting up input values for " + commodity + " commoditID:"
    ...
    public void setInputValuesInCommodityAndExchangeObjects() throws OverflowException
    {
        ...
        // First set TC, dTC
        final Iterator<CommodityZUtility> bUtils = commodity.getBuyingUtilitiesIterator();
        ...
        // Next set TP, dTP
        final Iterator<CommodityZUtility> sUtils = commodity.getSellingUtilitiesIterator();
