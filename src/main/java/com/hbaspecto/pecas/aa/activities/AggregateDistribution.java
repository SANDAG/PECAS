...
public abstract class AggregateDistribution extends AmountInZone implements AggregateAlternative {
     ...
     */
    protected abstract void allocateLocationChoiceAveragePriceDerivatives(double totalActivityQuantity, double[][] averagePriceSurplusMatrix, VectorI locationChoiceDerivatives) throws OverflowException;
