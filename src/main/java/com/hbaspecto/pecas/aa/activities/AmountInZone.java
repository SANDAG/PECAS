...
public class AmountInZone {
	...
	public void setLocationSpecificUtilityInclTaxes(
			double locationSpecificUtilityInclTaxes) {
	...
	public boolean equals(Object o) {
		final AmountInZone other = (AmountInZone) o;
		if (other == null) {
			return false;
		}
		if (other.myTaz.equals(myTaz)
	...
	@Override
	public int hashCode() {
		return myProductionActivity.hashCode() ^ myTaz.hashCode();
	};

	public double getAllocationSizeTerm() {
		return allocationSizeTerm;
	}

	public void setAllocationSizeTerm(double allocationSizeTerm) {
		this.allocationSizeTerm = allocationSizeTerm;
	}
	...
	public void setConstrained(boolean constrained) {
		...
		// constant is ignored in allocation but used in update, so let's set it
		// to 0.
		setLocationSpecificUtilityInclTaxes(0);
	}
