...
public class NonTransportableExchange
        extends Exchange
{
    ...
    void setFlowQuantity(int tazIndex, char selling, double quantity)
    {
        ...
        {
            throw new Error("Non transportable exchange zone for " + myCommodity + " in zone "
                    + exchangeLocationUserID
    ...
    public double getFlowQuantity(int tazIndex, char selling)
    {
        if (tazIndex != myLocationIndex)
        {
            throw new InvalidFlowError("Non transportable exchange zone for " + myCommodity
    ...
    public void addFlowIfNotAlreadyThere(CommodityZUtility f, boolean buying)
    {
        ...
        if (tazIndex != myLocationIndex)
        {
            throw new Error("Attempt to add an Interzonal flow to a non-transportable exchange "
