        ...
        implements AggregateAlternative /* CompositeAlternativeInterface */
{
    ...
    /**
     * Attribute describing the type of flow. theCommodityZUtility has
     * attributes describing the commodity being transferred, whether the
     * commodity is being bought or sold in the exchange zone, and what zone it
     * is being brought in from (for selling) or being shipped out to (for
     * buying).
     */
     ...
     * (sellingZUtility) ship a commodity to a market and sell it there; buyers
     * go to the market, buy commodities, and ship them back. theExchange
     * represents a market at a spatial location.
     */
