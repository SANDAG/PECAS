...
/**
 * This the the utility of buying or selling a commodity in a zone. It is a function of the commodity prices in the exchange zones and the associated
 * transport disutility.
 * 
 * @author John Abraham
 */
public class SellingZUtility
