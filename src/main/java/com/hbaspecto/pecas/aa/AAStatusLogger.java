...
public final class AAStatusLogger
{
     ...
     */
    public static void logHistogram(String title, double goal, double currentPoint,
            String xAxisLabel, String yAxisLabel)
    {
        if (enabled)
        {
            StatusLogger
                    .logHistogram(moduleName, title, goal, currentPoint, xAxisLabel, yAxisLabel);
        }
    }
     ...
     *            The label to use for the histogram's y-axis.
     */
    public static void logGraph(String title, double xPoint, double yPoint, String xAxisLabel,
            String yAxisLabel)
    {
        if (enabled)
        {
