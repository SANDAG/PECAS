...
public class PECASDataSource implements DataSource {
	...
	public PECASDataSource(String landDatabaseDriver,
			String urlLandDatabaseSpecifier, String user, String password) {
	...
	public Connection getConnection() throws SQLException {
		final Connection con = java.sql.DriverManager.getConnection(dburl,
	...
	public java.util.logging.Logger getParentLogger()
		...
		throw new SQLFeatureNotSupportedException("No parent logger for "
				+ PECASDataSource.class);
	}
