        ...
        extends Thread
{
    ...
    private final Logger                            logger         = Logger.getLogger(ParcelUpdater.class
                                                                           .getName());
    ...
    public ParcelUpdater(ResourceBundle props, String parcelTableName, String parcelIDField)
            throws SQLException
    {
        this.parcelTableName = parcelTableName;
        parcelIdField = parcelIDField;
        localProps = props;
        isAutoCommit = ResourceUtil.getBooleanProperty(localProps, "isAutoCommit", true);
    ...
    private void getUpdateStatement() throws SQLException
    {
        if (conn != null)
        {
            ...
            { // conn is closed
                conn = AssignSquareFeetToParcel.getNewConnection(localProps, false, isAutoCommit,
                        "The updater");
                setAvalidUpdateStatment(conn);
            }
    ...
    private void setAvalidUpdateStatment(Connection conn) throws SQLException
    {
        ...
        if (statement == null)
        {
            ...
            {
                statement = conn.prepareStatement("UPDATE " + parcelTableName + " SET \""
