...
class DemolishAlternative extends DevelopmentAlternative {
    ...
    public void doDevelopment() {
        ...
        if (size>ZoningRulesI.land.getMaxParcelSize()) {
            ...
            ZoningRulesI.land.getDevelopmentLogger().logDemolitionWithSplit(ZoningRulesI.land, newBit, oldDevQuantity); 
        } else {
            ...
            ZoningRulesI.land.getDevelopmentLogger().logDemolition(ZoningRulesI.land, oldDT, oldSquareFeet, oldYear, oldIsDerelict);
        }
    }
