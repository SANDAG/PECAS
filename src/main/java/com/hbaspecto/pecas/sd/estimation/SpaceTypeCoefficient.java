...
/**
 * A coefficient that has a single spacetype it applies to. This class
 * provides static methods to retrieve each coefficient type. They all
 * guarantee that they will return the same object every time they are
 * called with the same parameters, meaning that they can be compared
 * by object identity.
 */
public abstract class SpaceTypeCoefficient implements Coefficient
{
    ...
    protected static void insertNewCoefficient(String name, int spacetype, SpaceTypeCoefficient newCoeff)
    {
        if(theCoeffs.containsKey(name))
    ...
    private static class NoChangeConstant extends SpaceTypeCoefficient
    {
        ...
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_NoChangeTransitionConst(v);
        }
    }
    
    private static class DemolishTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_DemolishTransitionConst(v);
        }
    }
    
    private static class DerelictTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_DerelictTransitionConst(v);
        }
    }
    
    private static class RenovateTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_RenovateTransitionConst(v);
        }
    }
    ...
    private static class RenovateDerelictConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_RenovateDerelictTransitionConst(v);
        }
    }
    ...
    private static class AddTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_AddTransitionConst(v);
        }
    }
    
    private static class NewFromTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_NewFromTransitionConst(v);
        }
    }
    ...
    private static class NewToTransitionConstant extends SpaceTypeCoefficient
    {
        ...
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_NewToTransitionConst(v);
        }
    }
    
    private static class StepPoint extends SpaceTypeCoefficient
    {
        ...
        public double getValue()
        {
            return SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).get_StepPoint();
        }
    ...
    private static class BelowStepPointAdjustment extends SpaceTypeCoefficient
    {
        ...
        public double getValue()
        {
            return SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).get_BelowStepPointAdjustment();
        }

        @Override
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_BelowStepPointAdjustment(v);
        }
    }
    
    private static class AboveStepPointAdjustment extends SpaceTypeCoefficient
    {
        ...
        public double getValue()
        {
            return SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).get_AboveStepPointAdjustment();
        }

        @Override
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_AboveStepPointAdjustment(v);
        }
    }
    
    private static class StepPointAmount extends SpaceTypeCoefficient
    {
        ...
        public double getValue()
        {
            return SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).get_StepPointAdjustment();
        }

        @Override
        public void setValue(double v)
        {
            SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(getSpacetype()).set_StepPointAdjustment(v);
        }
    }
}
