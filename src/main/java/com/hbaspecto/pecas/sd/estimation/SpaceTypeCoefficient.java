...
public abstract class SpaceTypeCoefficient implements Coefficient {
	...
	protected static SpaceTypeCoefficient getExistingCoefficient(String name,
			int spacetype) {
		if (theCoeffs.containsKey(name)) {
			final HashMap<Integer, SpaceTypeCoefficient> spaceTypeCoeffs = theCoeffs
					.get(name);
	...
	public static SpaceTypeCoefficient getNoChangeConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(NO_CHANGE_CONST,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getDemolishTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				DEMOLISH_TRANSITION_CONST, spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getDerelictTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				DERELICT_TRANSITION_CONST, spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getRenovateTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				RENOVATE_TRANSITION_CONST, spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getRenovateDerelictConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				RENOVATE_DERELICT_CONST, spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getAddTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(ADD_TRANSITION_CONST,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getNewFromTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				NEW_FROM_TRANSITION_CONST, spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getNewToTransitionConst(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(
				NEW_TO_TRANSITION_CONST, spacetype);
		if (coeff == null) {
	...
	/**
	 * Returns the renovate/add space/build new dispersion parameter for the given
	 * spacetype.
	 */
	...
	/**
	 * Returns the density shaping function's adjustment below the step point for
	 * the given spacetype.
	 */
	public static SpaceTypeCoefficient getBelowStepPointAdj(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(BELOW_STEP_POINT_ADJ,
				spacetype);
		if (coeff == null) {
	...
	/**
	 * Returns the density shaping function's adjustment above the step point for
	 * the given spacetype.
	 */
	public static SpaceTypeCoefficient getAboveStepPointAdj(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(ABOVE_STEP_POINT_ADJ,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getStepPointAmount(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(STEP_POINT_AMOUNT,
				spacetype);
		if (coeff == null) {
