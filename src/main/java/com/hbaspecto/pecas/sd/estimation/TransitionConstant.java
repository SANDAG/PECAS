...
public class TransitionConstant implements Coefficient
{
    ...
    public double getValue()
    {
        ...
        return SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(spacetype1).getTransitionConstantTo(sess, spacetype2);
    }
    ...
    {
        SSessionJdbc sess = SSessionJdbc.getThreadLocalSession();
        SpaceTypesI.getAlreadyCreatedSpaceTypeBySpaceTypeID(spacetype1).setTransitionConstantTo(sess, spacetype2, v);
    }
