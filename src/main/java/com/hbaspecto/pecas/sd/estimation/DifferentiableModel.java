...
public interface DifferentiableModel
{
     ...
     * 
     * @param targets
     *            The list of targets, in the order in which their values should be returned.
     * @param params
    ...
    /**
     * Returns the Jacobian matrix of the derivatives of each target value with respect to each parameter. The rows of this matrix correspond to the
