...
public abstract class DispersionParameter extends SpaceTypeCoefficient {
	...
	public static SpaceTypeCoefficient getNoChangeDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(NO_CHANGE_DISP,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getChangeOptionsDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(CHANGE_OPTIONS_DISP,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getDemolishDerelictDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(DEMOLISH_DERELICT_DISP,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getRenovateAddNewDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(RENOVATE_ADD_NEW_DISP,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getNewTypeDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(NEW_TYPE_DISP,
				spacetype);
		if (coeff == null) {
	...
	public static SpaceTypeCoefficient getIntensityDisp(int spacetype) {
		SpaceTypeCoefficient coeff = getExistingCoefficient(INTENSITY_DISP,
				spacetype);
		if (coeff == null) {
