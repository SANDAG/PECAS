...
{
    /**
     * Checks whether this target is applicable to the current parcel, i.e. whether it is possible
     * even in principle for the parcel to add a contribution to the target value.
