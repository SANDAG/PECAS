...
public class EstimationMatrix
{
    ...
    public List<ExpectedValue> getTargetsApplicableToCurrentParcel()
    {
        ...
        for (ExpectedValue t : expValues)
            if (t.appliesToCurrentParcel()) sublist.add(t);
            ...
            implements List<E>
    {
        ...
        public boolean equals(Object o)
        {
            ...
            if (!(o instanceof BackMapList)) return false;
        ...
        {
            if (this.contains(o)) return backmap.get(o)[0];
            else return -1;
        }
        ...
        {
            if (this.contains(o)) return backmap.get(o)[1];
            else return -1;
        }
