        ...
        extends DevelopmentAlternative
{
    ...
    public void doDevelopment()
    {
        ...
        } else
        {
            ...
            if (zoningReg != null)
            {
                if (Math.min(zoningReg.get_MaxIntensityPermitted(), myDt.get_MaxIntensity())
                        * ZoningRulesI.land.getLandArea() > oldDevQuantity)
                {
            ...
            ChoiceModelOverflowException
    {
        ...
        double expectedNewSpace = 0; // Never any new space in a develop more
                                     // alternative.
