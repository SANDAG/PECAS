 ...
 * @author Abdel
 * @date August 5, 2009
 * This class represents the renovate alernative 
 */
public class RenovateAlternative extends DevelopmentAlternative {
    ...
    public void doDevelopment(){
		...
		if (size>ZoningRulesI.land.getMaxParcelSize()) {
			...
			ZoningRulesI.land.getDevelopmentLogger().logRenovationWithSplit(ZoningRulesI.land, newBit); 
		} else {
			...
			ZoningRulesI.land.getDevelopmentLogger().logRenovation(ZoningRulesI.land, old_year_built, oldIsDerelict);
		}	
	}
