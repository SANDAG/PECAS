 ...
 ***/
abstract class TransitionConstantsI_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<TransitionConstantsI> meta = new SRecordMeta<TransitionConstantsI>(
			TransitionConstantsI.class, "transition_constants_i");

	// Columns in table
	public static final SFieldInteger FromSpaceTypeId = new SFieldInteger(meta,
			"from_space_type_id", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
					SFieldFlags.SMANDATORY });

	public static final SFieldInteger ToSpaceTypeId = new SFieldInteger(meta,
			"to_space_type_id", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
					SFieldFlags.SMANDATORY });
	...
	public SpaceTypesI get_SPACE_TYPES_I(SSessionJdbc ses) {
		try {
			...
			return ses.findOrCreate(SpaceTypesI_gen.meta, new Object[] {
					get_FromSpaceTypeId(), get_ToSpaceTypeId(), });
		}
	...
	// Find and create
	public static TransitionConstantsI findOrCreate(SSessionJdbc ses,
			int _FromSpaceTypeId, int _ToSpaceTypeId) {
