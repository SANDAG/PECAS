 ...
 ***/
abstract class FloorspaceiView_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<FloorspaceiView> meta = new SRecordMeta<FloorspaceiView>(
			FloorspaceiView.class, "floorspacei_view");
	...
	public static final SFieldString AaCommodity = new SFieldString(meta,
			"aa_commodity", 2147483647);

	public static final SFieldDouble Quantity = new SFieldDouble(meta, "quantity");
