 ...
 ***/
abstract class CurrentYearTable_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<CurrentYearTable> meta = new SRecordMeta<CurrentYearTable>(
			CurrentYearTable.class, "current_year_table");

	// Columns in table
	public static final SFieldInteger CurrentYear = new SFieldInteger(meta,
			"current_year", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
