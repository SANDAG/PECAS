        ...
        implements java.io.Serializable
{
            ...
            int taz)
    {
        ...
        final SQuery<LocalEffectDistances> query = new SQuery<LocalEffectDistances>(meta)
                .innerJoin(PARCELSTEMP).eq(ParcelsTemp_gen.Taz, taz);
            ...
            SSessionJdbc session, int randomNumber)
    {
        // SQuery<LocalEffectDistances> query = SQuery<ParcelsTemp>(meta);
        final SQuery<LocalEffectDistances> query = new SQuery<LocalEffectDistances>(meta)
                .innerJoin(PARCELSTEMP).eq(ParcelsTemp_gen.Randnum, randomNumber);
        final List<LocalEffectDistances> list = session.query(query);
        return list;
