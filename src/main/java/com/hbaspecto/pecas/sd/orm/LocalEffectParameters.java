...
public class LocalEffectParameters extends LocalEffectParameters_gen implements java.io.Serializable {
	...
	public double applyFunction(double rent, double localEffectDistance) {
		...
		case 2:
			...
			break;
		case 3:
			rent *= Math.exp ( get_ThetaParameter()  * ( 1 - ( localEffectDistance / get_MaxDist() ) ) );
			break;
		case 4:
		...
		case 6:
			...
			break;
		case 7:
			rent *= Math.pow( 1 - get_ThetaParameter(), 1 - ( localEffectDistance  / get_MaxDist() ) );
			break;
		case 8:
