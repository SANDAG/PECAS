 ...
 ***/
abstract class ParcelCostXref_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<ParcelCostXref> meta = new SRecordMeta<ParcelCostXref>(
			ParcelCostXref.class, "parcel_cost_xref");
	...
	// Find and create
	public static ParcelCostXref findOrCreate(SSessionJdbc ses,
	...
	public static ParcelCostXref findOrCreate(SSessionJdbc ses, Parcels _ref,
			int _YearEffective) {
