 ...
 ***/
abstract class SpaceToCommodity_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<SpaceToCommodity> meta = new SRecordMeta<SpaceToCommodity>(
			SpaceToCommodity.class, "space_to_commodity");
	...
	public static final SFieldString AaCommodity = new SFieldString(meta,
			"aa_commodity", 2147483647, new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
					SFieldFlags.SMANDATORY });

	public static final SFieldDouble Weight = new SFieldDouble(meta, "weight",
	...
	// Find and create
	public static SpaceToCommodity findOrCreate(SSessionJdbc ses,
			int _SpaceTypeId, String _AaCommodity) {
		return ses.findOrCreate(meta, new Object[] { new Integer(_SpaceTypeId),
				_AaCommodity });
	}

	public static SpaceToCommodity findOrCreate(SSessionJdbc ses,
			SpaceTypesI _ref, String _AaCommodity) {
