...
/**
 * Base class of table local_effect_distances.<br>
 * Do not edit as will be regenerated by running SimpleORMGenerator Generated on Fri Sep 25 16:13:29 MDT 2009
 ***/
abstract class LocalEffectDistances_gen
        extends SRecordInstance
        implements java.io.Serializable
{

    public static final SRecordMeta<LocalEffectDistances> meta                = new SRecordMeta<LocalEffectDistances>(
                                                                                      LocalEffectDistances.class,
                                                                                      "local_effect_distances");

    // Columns in table
    public static final SFieldLong                        PecasParcelNum      = new SFieldLong(
                                                                                      meta,
                                                                                      "pecas_parcel_num",
                                                                                      new SFieldFlags[] {
    ...
    public static final SFieldDouble                      LocalEffectDistance = new SFieldDouble(
                                                                                      meta,
                                                                                      "local_effect_distance");

    public static final SFieldInteger                     YearEffective       = new SFieldInteger(
                                                                                      meta,
                                                                                      "year_effective",
                                                                                      new SFieldFlags[] {
            SFieldFlags.SPRIMARY_KEY, SFieldFlags.SMANDATORY                          });
    ...
    public Parcels get_PARCELS(SSessionJdbc ses)
    {
        ...
        {
            /**
             * Old code: return Parcels.findOrCreate(get_PecasParcelNum()); New code below :
             **/
    ...
    // Find and create
    public static LocalEffectDistances findOrCreate(SSessionJdbc ses, long _PecasParcelNum,
            int _LocalEffectId, int _YearEffective)
    {
        return ses.findOrCreate(meta, new Object[] {new Long(_PecasParcelNum),
                new Integer(_LocalEffectId), new Integer(_YearEffective)});
    }

    public static LocalEffectDistances findOrCreate(SSessionJdbc ses, LocalEffects _ref,
            long _PecasParcelNum, int _YearEffective)
    {
        return findOrCreate(ses, _PecasParcelNum, _ref.get_LocalEffectId(), _YearEffective);
    }

    public static LocalEffectDistances findOrCreate(SSessionJdbc ses, Parcels _ref,
            int _LocalEffectId, int _YearEffective)
    {
