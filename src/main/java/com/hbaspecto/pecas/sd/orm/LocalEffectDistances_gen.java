 ...
 ***/
abstract class LocalEffectDistances_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<LocalEffectDistances> meta = new SRecordMeta<LocalEffectDistances>(
			LocalEffectDistances.class, "local_effect_distances");
	...
	// Find and create
	public static LocalEffectDistances findOrCreate(SSessionJdbc ses,
			long _PecasParcelNum, int _LocalEffectId, int _YearEffective) {
		return ses.findOrCreate(meta, new Object[] { new Long(_PecasParcelNum),
				new Integer(_LocalEffectId), new Integer(_YearEffective) });
	}

	public static LocalEffectDistances findOrCreate(SSessionJdbc ses,
			LocalEffects _ref, long _PecasParcelNum, int _YearEffective) {
		return findOrCreate(ses, _PecasParcelNum, _ref.get_LocalEffectId(),
				_YearEffective);
	}

	public static LocalEffectDistances findOrCreate(SSessionJdbc ses,
			Parcels _ref, int _LocalEffectId, int _YearEffective) {
		return findOrCreate(ses, _ref.get_PecasParcelNum(), _LocalEffectId,
				_YearEffective);
	}
