 ...
 ***/
abstract class TransitionConstantsIView_gen
        ...
        implements java.io.Serializable
{
    ...
    public static final SRecordMeta<TransitionConstantsIView> meta               = new SRecordMeta<TransitionConstantsIView>(
                                                                                         TransitionConstantsIView.class,
                                                                                         "transition_constants_i_view");

    // Columns in table
    public static final SFieldString                          FromSpaceTypeName  = new SFieldString(
                                                                                         meta,
                                                                                         "from_space_type_name",
                                                                                         2147483647);

    public static final SFieldString                          ToSpaceTypeName    = new SFieldString(
                                                                                         meta,
                                                                                         "to_space_type_name",
                                                                                         2147483647);
