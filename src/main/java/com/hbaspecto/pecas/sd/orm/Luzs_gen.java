...
abstract class Luzs_gen extends SRecordInstance implements java.io.Serializable {
	...
	public static final SRecordMeta<Luzs> meta = new SRecordMeta<Luzs>(
			Luzs.class, "luzs");

	// Columns in table
	public static final SFieldInteger LuzNumber = new SFieldInteger(meta,
			"luz_number", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
					SFieldFlags.SMANDATORY });

	public static final SFieldString LuzName = new SFieldString(meta, "luz_name",
			2147483647);
