 ...
 ***/
public abstract class ObservedDevelopmentEvents_gen extends SRecordInstance
		implements java.io.Serializable {

	public static final SRecordMeta<ObservedDevelopmentEvents> meta = new SRecordMeta<ObservedDevelopmentEvents>(
			ObservedDevelopmentEvents.class, "observed_development_events");

	// Columns in table
	public static final SFieldString EventType = new SFieldString(meta,
			"event_type", 2147483647);

	public static final SFieldString ParcelId = new SFieldString(meta,
			"parcel_id", 2147483647);

	public static final SFieldLong OriginalPecasParcelNum = new SFieldLong(meta,
			"original_pecas_parcel_num", new SFieldFlags[] {
					SFieldFlags.SPRIMARY_KEY, SFieldFlags.SMANDATORY });

	public static final SFieldLong NewPecasParcelNum = new SFieldLong(meta,
			"New_pecas_parcel_num");
	// ,new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY, SFieldFlags.SMANDATORY });

	public static final SFieldInteger AvailableServices = new SFieldInteger(meta,
			"available_services");

	public static final SFieldInteger OldSpaceTypeId = new SFieldInteger(meta,
			"old_space_type_id");

	public static final SFieldInteger NewSpaceTypeId = new SFieldInteger(meta,
			"new_space_type_id");

	public static final SFieldDouble OldSpaceQuantity = new SFieldDouble(meta,
			"old_space_quantity");

	public static final SFieldDouble NewSpaceQuantity = new SFieldDouble(meta,
			"new_space_quantity");

	public static final SFieldInteger OldYearBuilt = new SFieldInteger(meta,
			"old_year_built");

	public static final SFieldInteger NewYearBuilt = new SFieldInteger(meta,
			"new_year_built");

	public static final SFieldDouble LandArea = new SFieldDouble(meta,
			"land_area");

	public static final SFieldBooleanBit OldIsDerelict = new SFieldBooleanBit(
			meta, "old_is_derelict");

	public static final SFieldBooleanBit NewIsDerelict = new SFieldBooleanBit(
			meta, "new_is_derelict");

	public static final SFieldBooleanBit OldIsBrownfield = new SFieldBooleanBit(
			meta, "old_is_brownfield");

	public static final SFieldBooleanBit NewIsBrownfield = new SFieldBooleanBit(
			meta, "new_is_brownfield");
	...
	// Find and create
	public static ObservedDevelopmentEvents findOrCreate(SSessionJdbc ses,
			long _PecasParcelNum) {
