 ...
 ***/
abstract class MostRecentLocalEffectYear_gen
        extends SRecordInstance
        implements java.io.Serializable
{

    public static final SRecordMeta<MostRecentLocalEffectYear> meta                   = new SRecordMeta<MostRecentLocalEffectYear>(
                                                                                              MostRecentLocalEffectYear.class,
                                                                                              "most_recent_local_effect_year");
