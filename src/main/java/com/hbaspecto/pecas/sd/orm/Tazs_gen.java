 ...
 ***/
public abstract class Tazs_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<Tazs> meta = new SRecordMeta<Tazs>(
			Tazs.class, "tazs");
	...
	public static final SFieldInteger LuzNumber = new SFieldInteger(meta,
			"luz_number", new SFieldFlags[] { SFieldFlags.SMANDATORY });

	public static final SFieldInteger CountyFips = new SFieldInteger(meta,
			"county_fips");
	...
	public Luzs get_LUZS(SSessionJdbc ses) {
		try {
			/**
			 * Old code: return Luzs.findOrCreate(get_LuzNumber()); New code below :
			 **/
			return ses.findOrCreate(Luzs_gen.meta, new Object[] { get_LuzNumber(), });
		}
