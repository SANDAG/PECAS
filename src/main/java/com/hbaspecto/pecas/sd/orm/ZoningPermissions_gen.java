 ...
 ***/
public abstract class ZoningPermissions_gen
        ...
        implements java.io.Serializable
{
    ...
    public ZoningPermissions_gen()
    {
        if (meta == null)
        {
            final String msg = ZoningPermissions_gen.class.getName()
    ...
    public static void init(ResourceBundle rb)
    {
        ...
        meta = new SRecordMeta<ZoningPermissions>(ZoningPermissions.class,
                ResourceUtil.getProperty(rb, "sdorm.zoning_permissions", "zoning_permissions"));

        // Columns in table
        ZoningRulesCode = new SFieldInteger(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.zoning_rules_code", "zoning_rules_code"),
        ...
        SpaceTypeId = new SFieldInteger(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.space_type_id", "space_type_id"), new SFieldFlags[] {
                SFieldFlags.SPRIMARY_KEY, SFieldFlags.SMANDATORY});

        MinIntensityPermitted = new SFieldDouble(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.min_intensity_permitted", "min_intensity_permitted"));

        MaxIntensityPermitted = new SFieldDouble(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.max_intensity_permitted", "max_intensity_permitted"));

        AcknowledgedUse = new SFieldBooleanBit(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.acknowledged_use", "acknowledged_use"));

        PenaltyAcknowledgedSpace = new SFieldDouble(meta,
                ResourceUtil.getProperty(rb, "sdorm.zoning_permissions.penalty_acknowledged_space",
                        "penalty_acknowledged_space"));

        PenaltyAcknowledgedLand = new SFieldDouble(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.penalty_acknowledged_land", "penalty_acknowledged_land"));

        ServicesRequirement = new SFieldInteger(meta, ResourceUtil.getProperty(rb,
                "sdorm.zoning_permissions.services_requirement", "services_requirement"));
    ...
    public void set_MinIntensityPermitted(double value)
    {
        setDouble(MinIntensityPermitted, value);
    }
    ...
    public void set_MaxIntensityPermitted(double value)
    {
        setDouble(MaxIntensityPermitted, value);
    }
    ...
    public void set_AcknowledgedUse(boolean value)
    {
        setBoolean(AcknowledgedUse, value);
    }
    ...
    public void set_PenaltyAcknowledgedSpace(double value)
    {
        setDouble(PenaltyAcknowledgedSpace, value);
    }
    ...
    public void set_PenaltyAcknowledgedLand(double value)
    {
        setDouble(PenaltyAcknowledgedLand, value);
    }
    ...
    public void set_ServicesRequirement(int value)
    {
        setInt(ServicesRequirement, value);
    }
    ...
    public SpaceTypesI get_SPACE_TYPES_I(SSessionJdbc ses)
    {
        try
        {
             ...
             * code below :
             **/
            return ses.findOrCreate(SpaceTypesI_gen.meta, new Object[] {get_SpaceTypeId(),});
    ...
    public ZoningRulesI get_ZONING_RULES_I(SSessionJdbc ses)
    {
        try
        {
            /**
             * Old code: return
             * ZoningRulesI.findOrCreate(get_ZoningRulesCode()); New code below
             * :
             **/
            return ses.findOrCreate(ZoningRulesI_gen.meta, new Object[] {get_ZoningRulesCode(),});
        } catch (final SException e)
        {
            if (e.getMessage().indexOf("Null Primary key") > 0)
            {
    ...
    // Find and create
    public static ZoningPermissions findOrCreate(SSessionJdbc ses, int _ZoningRulesCode,
            int _SpaceTypeId)
    {
        return ses.findOrCreate(meta, new Object[] {new Integer(_ZoningRulesCode),
                new Integer(_SpaceTypeId)});
    }

    public static ZoningPermissions findOrCreate(SSessionJdbc ses, SpaceTypesI _ref,
            int _ZoningRulesCode)
    {
        return findOrCreate(ses, _ZoningRulesCode, _ref.get_SpaceTypeId());
    }

    public static ZoningPermissions findOrCreate(SSessionJdbc ses, ZoningRulesI _ref,
            int _SpaceTypeId)
    {
