 ...
 ***/
public abstract class ZoningPermissions_gen extends SRecordInstance implements
	...
	public static void init(ResourceBundle rb) {
		...
		meta = new SRecordMeta<ZoningPermissions>(ZoningPermissions.class,
				ResourceUtil.getProperty(rb, "sdorm.zoning_permissions",
						"zoning_permissions"));
		...
		PenaltyAcknowledgedSpace = new SFieldDouble(meta, ResourceUtil.getProperty(
				rb, "sdorm.zoning_permissions.penalty_acknowledged_space",
				"penalty_acknowledged_space"));

		PenaltyAcknowledgedLand = new SFieldDouble(meta, ResourceUtil.getProperty(
				rb, "sdorm.zoning_permissions.penalty_acknowledged_land",
				"penalty_acknowledged_land"));

		ServicesRequirement = new SFieldInteger(meta,
	...
	// Find and create
	public static ZoningPermissions findOrCreate(SSessionJdbc ses,
			int _ZoningRulesCode, int _SpaceTypeId) {
		return ses.findOrCreate(meta, new Object[] { new Integer(_ZoningRulesCode),
				new Integer(_SpaceTypeId) });
	}

	public static ZoningPermissions findOrCreate(SSessionJdbc ses,
			SpaceTypesI _ref, int _ZoningRulesCode) {
		return findOrCreate(ses, _ZoningRulesCode, _ref.get_SpaceTypeId());
	}

	public static ZoningPermissions findOrCreate(SSessionJdbc ses,
			ZoningRulesI _ref, int _SpaceTypeId) {
