 ...
 ***/
abstract class MostRecentFeeYear_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<MostRecentFeeYear> meta = new SRecordMeta<MostRecentFeeYear>(
			MostRecentFeeYear.class, "most_recent_fee_year");

	// Columns in table
	public static final SFieldLong PecasParcelNum = new SFieldLong(meta,
			"pecas_parcel_num");

	public static final SFieldInteger CurrentFeeYear = new SFieldInteger(meta,
			"current_fee_year");
	...
	public void set_CurrentFeeYear(int value) {
		setInt(CurrentFeeYear, value);
	}
