 ...
 ***/
abstract class LocalEffectParameters_gen
        ...
        implements java.io.Serializable
{
    ...
    public static final SRecordMeta<LocalEffectParameters> meta           = new SRecordMeta<LocalEffectParameters>(
                                                                                  LocalEffectParameters.class,
                                                                                  "local_effect_parameters");

    // Columns in table
    public static final SFieldInteger                      LocalEffectId  = new SFieldInteger(
                                                                                  meta,
                                                                                  "local_effect_id",
                                                                                  new SFieldFlags[] {
    ...
    public static final SFieldDouble                       MaxDist        = new SFieldDouble(meta,
                                                                                  "max_dist");
    ...
    public LocalEffects get_LOCAL_EFFECTS(SSessionJdbc ses)
    {
        ...
        {
            /**
             * Old code: return LocalEffects.findOrCreate(get_LocalEffectId());
             * New code below :
             **/
            return ses.findOrCreate(LocalEffects_gen.meta, new Object[] {get_LocalEffectId(),});
    ...
    // Find and create
    public static LocalEffectParameters findOrCreate(SSessionJdbc ses, int _LocalEffectId,
            int _SpaceTypeId)
    {
    ...
    public static LocalEffectParameters findOrCreate(SSessionJdbc ses, LocalEffects _ref,
            int _SpaceTypeId)
    {
        return findOrCreate(ses, _ref.get_LocalEffectId(), _SpaceTypeId);
    }

    public static LocalEffectParameters findOrCreate(SSessionJdbc ses, SpaceTypesI _ref,
            int _LocalEffectId)
    {
