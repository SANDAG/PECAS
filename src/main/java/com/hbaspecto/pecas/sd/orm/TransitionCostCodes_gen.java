 ...
 ***/
abstract class TransitionCostCodes_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<TransitionCostCodes> meta = new SRecordMeta<TransitionCostCodes>(
			TransitionCostCodes.class, "transition_cost_codes");
	...
	// Find and create
	public static TransitionCostCodes findOrCreate(SSessionJdbc ses,
			int _CostScheduleId) {
		return ses
				.findOrCreate(meta, new Object[] { new Integer(_CostScheduleId) });
	}
