 ...
 ***/
abstract class ParcelFeeXref_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<ParcelFeeXref> meta = new SRecordMeta<ParcelFeeXref>(
			ParcelFeeXref.class, "parcel_fee_xref");
	...
	// Find and create
	public static ParcelFeeXref findOrCreate(SSessionJdbc ses,
	...
	public static ParcelFeeXref findOrCreate(SSessionJdbc ses, Parcels _ref,
			int _YearEffective) {
