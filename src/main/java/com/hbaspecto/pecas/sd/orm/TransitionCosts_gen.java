 ...
 ***/
abstract class TransitionCosts_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<TransitionCosts> meta = new SRecordMeta<TransitionCosts>(
			TransitionCosts.class, "transition_costs");

	// Columns in table
	public static final SFieldInteger CostScheduleId = new SFieldInteger(meta,
			"cost_schedule_id", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
	...
	public static final SFieldDouble DemolitionCost = new SFieldDouble(meta,
			"demolition_cost");

	public static final SFieldDouble RenovationCost = new SFieldDouble(meta,
			"renovation_cost");

	public static final SFieldDouble AdditionCost = new SFieldDouble(meta,
			"addition_cost");

	public static final SFieldDouble ConstructionCost = new SFieldDouble(meta,
			"construction_cost");

	public static final SFieldDouble RenovationDerelictCost = new SFieldDouble(
			meta, "renovation_derelict_cost");
	...
	public void set_DemolitionCost(double value) {
		setDouble(DemolitionCost, value);
	}
	...
	public void set_RenovationCost(double value) {
		setDouble(RenovationCost, value);
	}
	...
	public void set_RenovationDerelictCost(double value) {
		setDouble(RenovationDerelictCost, value);
	}
	...
	public void set_AdditionCost(double value) {
		setDouble(AdditionCost, value);
	}
	...
	public void set_ConstructionCost(double value) {
		setDouble(ConstructionCost, value);
	}
	...
	public TransitionCostCodes get_TRANSITION_COST_CODES(SSessionJdbc ses) {
		try {
			/**
			 * Old code: return
			 * TransitionCostCodes.findOrCreate(get_CostScheduleId()); New code below
			 * :
			 **/
			return ses.findOrCreate(TransitionCostCodes_gen.meta,
					new Object[] { get_CostScheduleId(), });
		}
		catch (final SException e) {
			if (e.getMessage().indexOf("Null Primary key") > 0) {
				return null;
	...
	// Find and create
	public static TransitionCosts findOrCreate(SSessionJdbc ses,
			int _CostScheduleId, int _SpaceTypeId) {
		return ses.findOrCreate(meta, new Object[] { new Integer(_CostScheduleId),
				new Integer(_SpaceTypeId) });
	}

	public static TransitionCosts findOrCreate(SSessionJdbc ses,
			SpaceTypesI _ref, int _CostScheduleId) {
		return findOrCreate(ses, _CostScheduleId, _ref.get_SpaceTypeId());
	}

	public static TransitionCosts findOrCreate(SSessionJdbc ses,
			TransitionCostCodes _ref, int _SpaceTypeId) {
