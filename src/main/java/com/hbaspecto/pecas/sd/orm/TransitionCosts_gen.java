        ...
        implements java.io.Serializable
{
    ...
    public TransitionCostCodes get_TRANSITION_COST_CODES(SSessionJdbc ses)
    {
        ...
        {
            /**
             * Old code: return TransitionCostCodes.findOrCreate(get_CostScheduleId()); New code below :
             **/
            return ses.findOrCreate(TransitionCostCodes.meta, new Object[] {get_CostScheduleId(),});
        } catch (SException e)
        {
            if (e.getMessage().indexOf("Null Primary key") > 0)
            {
