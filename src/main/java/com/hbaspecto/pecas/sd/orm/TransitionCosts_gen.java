        ...
        implements java.io.Serializable
{
    ...
    public static final SFieldDouble                 DemolitionCost         = new SFieldDouble(
                                                                                    meta,
                                                                                    "demolition_cost");

    public static final SFieldDouble                 RenovationCost         = new SFieldDouble(
                                                                                    meta,
                                                                                    "renovation_cost");

    public static final SFieldDouble                 AdditionCost           = new SFieldDouble(
                                                                                    meta,
                                                                                    "addition_cost");

    public static final SFieldDouble                 ConstructionCost       = new SFieldDouble(
                                                                                    meta,
                                                                                    "construction_cost");

    public static final SFieldDouble                 RenovationDerelictCost = new SFieldDouble(
                                                                                    meta,
                                                                                    "renovation_derelict_cost");
    ...
    public TransitionCostCodes get_TRANSITION_COST_CODES(SSessionJdbc ses)
    {
        try
        {
            /**
             * Old code: return
             * TransitionCostCodes.findOrCreate(get_CostScheduleId()); New code
             * below :
             **/
    ...
    // Find and create
    public static TransitionCosts findOrCreate(SSessionJdbc ses, int _CostScheduleId,
            int _SpaceTypeId)
    {
    ...
    public static TransitionCosts findOrCreate(SSessionJdbc ses, SpaceTypesI _ref,
            int _CostScheduleId)
    {
        return findOrCreate(ses, _CostScheduleId, _ref.get_SpaceTypeId());
    }

    public static TransitionCosts findOrCreate(SSessionJdbc ses, TransitionCostCodes _ref,
            int _SpaceTypeId)
    {
