...
abstract class ConstructionCommodities_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<ConstructionCommodities> meta = new SRecordMeta<ConstructionCommodities>(
			ConstructionCommodities.class, "construction_commodities");

	// Columns in table
	public static final SFieldInteger CcCommodityId = new SFieldInteger(meta,
			"cc_commodity_id", new SFieldFlags[] { SFieldFlags.SPRIMARY_KEY,
					SFieldFlags.SMANDATORY });

	public static final SFieldString CcCommodityName = new SFieldString(meta,
			"cc_commodity_name", 100);

	public static final SFieldInteger SpaceTypesGroupId = new SFieldInteger(meta,
			"space_types_group_id");

	public static final SFieldDouble ConvertingFactor = new SFieldDouble(meta,
			"converting_factor");
	...
	public SpaceTypesGroup get_SPACE_TYPES_GROUP(SSessionJdbc ses) {
		try {
			/**
			 * Old code: return SpaceTypesGroup.findOrCreate(get_SpaceTypesGroupId());
			 * New code below :
			 **/
			return ses.findOrCreate(SpaceTypesGroup_gen.meta,
					new Object[] { get_SpaceTypesGroupId(), });
		}
	...
	// Find and create
	public static ConstructionCommodities findOrCreate(SSessionJdbc ses,
			int _CcCommodityId) {
