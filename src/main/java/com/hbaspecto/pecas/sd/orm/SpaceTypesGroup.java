        ...
        implements java.io.Serializable
{
    ...
    public static double getTargetConstructionQuantity(int spaceGroupID)
    {
         ...
         * their total production (TPc). SELECT commodity, sum(internal_bought)
         * as sum from exchange_results WHERE LUZ in (SELECT luz_number from
         * luzs) AND commodity in (SELECT cc_commodity_name FROM
         * construction_commodities WHERE space_types_group_id = spaceGroupID)
         * GROUP BY commodity
         */
