    ...
    public static double getTargetConstructionQuantity(int spaceGroupID)
    {
        ...
        } else
        {
            ...
            while (cc.hasNext())
            {
                ...
                // sd_rents?
                final double tp = ((Double) session.rawQuerySingle(
            ...
            final SQuery<SpaceTypesI> query = new SQuery<SpaceTypesI>(SpaceTypesI_gen.meta).eq(
                    SpaceTypesI_gen.SpaceTypeGroupId, spaceGroupID);
