 ...
 ***/
abstract class DevelopmentFeeSchedules_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<DevelopmentFeeSchedules> meta = new SRecordMeta<DevelopmentFeeSchedules>(
			DevelopmentFeeSchedules.class, "development_fee_schedules");
	...
	// Find and create
	public static DevelopmentFeeSchedules findOrCreate(SSessionJdbc ses,
			int _FeeScheduleId) {
