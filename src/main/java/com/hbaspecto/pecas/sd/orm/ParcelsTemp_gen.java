 ...
 * Thu Nov 26 14:35:39 MST 2009
 ***/
public class ParcelsTemp_gen extends SRecordInstance implements
		java.io.Serializable {

	public static final SRecordMeta<ParcelsTemp> meta = new SRecordMeta<ParcelsTemp>(
			ParcelsTemp.class, "parcels_temp");
	...
	public static final SFieldInteger AvailableServicesCode = new SFieldInteger(
			meta, "available_services_code");
	...
	public static final SFieldBooleanBit IsBrownfield = new SFieldBooleanBit(
			meta, "is_brownfield");

	public static final SFieldDouble Randnum = new SFieldDouble(meta, "randnum");
