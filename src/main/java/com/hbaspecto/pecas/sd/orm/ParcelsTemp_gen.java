 ...
 * Do not edit as will be regenerated by running SimpleORMGenerator Generated on Thu Nov 26 14:35:39 MST 2009
 ***/
public class ParcelsTemp_gen
        extends SRecordInstance
        implements java.io.Serializable
{

    public static final SRecordMeta<ParcelsTemp> meta                  = new SRecordMeta<ParcelsTemp>(
                                                                               ParcelsTemp.class,
                                                                               "parcels_temp");
    ...
    public static final SFieldInteger            YearBuilt             = new SFieldInteger(meta,
                                                                               "year_built");

    public static final SFieldInteger            Taz                   = new SFieldInteger(meta,
                                                                               "taz");

    public static final SFieldInteger            SpaceTypeId           = new SFieldInteger(meta,
                                                                               "space_type_id");

    public static final SFieldDouble             SpaceQuantity         = new SFieldDouble(meta,
                                                                               "space_quantity");

    public static final SFieldDouble             LandArea              = new SFieldDouble(meta,
                                                                               "land_area");

    public static final SFieldInteger            AvailableServicesCode = new SFieldInteger(meta,
                                                                               "available_services_code");
    ...
    public static final SFieldBooleanBit         IsDerelict            = new SFieldBooleanBit(meta,
                                                                               "is_derelict");

    public static final SFieldBooleanBit         IsBrownfield          = new SFieldBooleanBit(meta,
                                                                               "is_brownfield");

    public static final SFieldDouble             Randnum               = new SFieldDouble(meta,
                                                                               "randnum");
