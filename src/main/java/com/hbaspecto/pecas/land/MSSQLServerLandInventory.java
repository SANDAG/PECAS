...
public class MSSQLServerLandInventory
        extends SimpleORMLandInventory
{
    ...
    public MSSQLServerLandInventory(ResourceBundle rb, String landDatabaseDriver,
            String landDatabaseSpecifier, String user, String password, String logFileNameAndPath,
    ...
    public void applyDevelopmentChanges()
    {
        ...
        try
        {
            ...
            final String exactpath = ResourceUtil.checkAndGetProperty(rbSD, "Exactpath");
            ...
            statement.execute("BULK INSERT development_events FROM '" + exactpath
                    + "DevelopmentEvents.csv" + "' WITH (FIRSTROW = 2,FORMATFILE='" + exactpath
                    + "development_events.xml');");
            ...
            String strUpdate = "UPDATE "
                    ...
                    + "           d.event_type = 'A' OR " + "           d.event_type = 'L' OR "
                    + "           d.event_type = 'R' );\n";
            ...
            strUpdate += "INSERT INTO " + Parcels_gen.meta.getTableName() + " "
                    ...
                    + "		new_space_quantity, " + "		land_area, " + "		available_services, "
                    + "		new_is_derelict, " + "		new_is_brownfield "
                    + "   	FROM development_events d " + "    	WHERE "
                    + "	     d.event_type = 'CS' " + "	OR   d.event_type = 'AS' "
                    + "	OR   d.event_type = 'RS' " + "	OR   d.event_type = 'DS' "
                    + "	OR   d.event_type = 'LS' " + "   	; \n";
            ...
            strUpdate += " INSERT INTO parcel_cost_xref "
                    ...
                    + " WHERE xref.pecas_parcel_num=de.original_pecas_parcel_num " + " AND ( "
                    + "     	 event_type = 'CS' " + "	OR   event_type = 'AS' "
                    + "	OR   event_type = 'RS' " + "	OR   event_type = 'DS' "
                    + "	OR   event_type = 'LS' ) " + "	; \n";
            ...
            strUpdate += " INSERT INTO local_effect_distances "
                    ...
                    + " WHERE dist.pecas_parcel_num=de.original_pecas_parcel_num " + " AND ( "
                    + "     	 event_type = 'CS' " + "	OR   event_type = 'AS' "
                    + "	OR   event_type = 'RS' " + "	OR   event_type = 'DS' "
                    + "	OR   event_type = 'LS' ) " + "	; \n";
        ...
        try
        {
            ...
            statement.execute("SELECT fp.pecas_parcel_num as parcel_id, "
                    + // TODO: In Cali there is no parcel_id. We use
                      // pecasParcelNum
                    "fp.pecas_parcel_num, " + "fp.year_built, fp.taz, " + "fp.space_type_id, "
                    + "fp.space_quantity, " + "fp.land_area, " + "fp.available_services_code, "
                    + "zxref.zoning_rules_code, " + "costxref.cost_schedule_id, "
                    + "feexref.fee_schedule_id, " + "fp.is_derelict, " + "fp.is_brownfield, "
